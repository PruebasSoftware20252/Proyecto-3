...
public class EliminarSteps {
    ...
    public void el_sistema_elimina_el_producto_y_muestra_un_mensaje_de_confirmacion() {
        Assertions.assertEquals(normalizeAsciiLower("Eliminazaciòn del producto exitosa"),normalizeAsciiLower(mainPage.obtenerMensaje()),"Eliminación del producto exitosa");
    }
